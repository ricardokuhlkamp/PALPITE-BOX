...
const Pesquisa = () => {
    ...
    return (
        <div className="pt-6">
            ...
            <h1 className="font-bold text-2xl text-center my-4">Críticas e sugestões</h1>
            <p className='text-center mb-6'>
                O restaurante X sempre busca por atender mehor seus clientes. <br/>
            ...
            { !sucess && <div className="w-1/5 mx-auto">
                ...
                <button className="bg-blue-400 rounded-lg shadow-lg px-12 py-4 font-bold hover:shadow" onClick={save}>Salvar</button>    
            </div>} 
            { sucess && <div className='w-1/5 mx-auto' >
